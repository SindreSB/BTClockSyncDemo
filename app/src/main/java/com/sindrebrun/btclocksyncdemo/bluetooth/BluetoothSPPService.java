...
public class BluetoothSPPService {
    ...
    private synchronized void updateUserInterfaceTitle() {
        ...
        mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_STATE_CHANGE, mNewState, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSPPHandler.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSPPHandler.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSPPHandler.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothSPPHandler.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
